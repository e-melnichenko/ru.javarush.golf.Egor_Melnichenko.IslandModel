...
import com.islanddd.src.entities.animal.AnimalKind;
import com.islanddd.src.entities.animal.herbivore.*;
import com.islanddd.src.entities.animal.omnivore.*;
import com.islanddd.src.entities.animal.predator.*;
import com.islanddd.src.entities.settings.Settings;
import com.islanddd.src.entities.vegetation.Vegetation;
...
public class Location {
    ...
    public void clear() {
        ...
        animalsMap.values().forEach(list -> {
            list.forEach(animal -> animal.isChild = false);
            list.removeIf(animal -> {
                return animal.isDead || animal.satiety < animal.base.wastedSatietyPerStep;
            });
        });
        lock.unlock();
    }
